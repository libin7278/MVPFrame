 ...
 *     desc  : 默认实现类 {@link FragmentProxy}
 * </pre>
 *
 * @see BaseActivity
 */
public class FragmentProxyImpl implements FragmentProxy {
    ...
    public FragmentProxyImpl(@NonNull android.support.v4.app.FragmentManager fragmentManager, @NonNull android.support.v4.app.Fragment fragment) {
